...
public class EntityNotFoundException extends RuntimeException {
    ...
    public EntityNotFoundException(Class<? extends AbstractEntity> entity, Long id) {
        super(format(CANNOT_FIND_OBJECT, entity.getName(), ID, id));
        this.entity = entity;
        this.id = id;
    }

    public static Supplier<EntityNotFoundException> entityNotFoundException(Class<? extends AbstractEntity> entity, Long id) {
